...
const secretMessages = [
    "Secret #1: I love you more than pizza. And you know how much I love pizza. But seriously, you're my absolute favorite person in the universe. 🍕🩵",
    "Secret #2: I still look at you when you aren't looking and think 'damn, I really hit the jackpot'. Thanks for being mine. 👀✨",
    "Secret #3: Your laugh is my favorite sound in the world, even when you're laughing at me for doing something stupid. 🥰😂",
    "Secret #4: You are officially stuck with me forever. No refunds, no exchanges, and absolutely no store credit. Love you! 🛑🤍",
    "Secret #5: Even when you take up 80% of the bed and leave me clinging to the edge for survival, there's no one else I'd rather sleep next to. 🛏️🩵",
    "Secret #6: If we were in a horror movie, I'd totally sacrifice myself to save you. (Unless it's a giant spider, then we are both going down together). 🕷️🫶",
    "Secret #7: I love you more today than I did yesterday. Except for that brief moment earlier when you stole my fries right out of my hand. 🍟🤭",
    ...
    "Secret #11: I am so deeply in love with you that even your cold toes touching my legs under the blankets can't ruin my mood. 🥶🩵",
    ...
    "Secret #19: You have the biggest heart of anyone I know. I am so lucky that I get to keep a huge piece of it. 🗺️🤍",
    ...
    "Secret #22: You're my favorite person to send stupid memes to at 2 AM. Thank you for always matching my frequency. 📱🤪",
